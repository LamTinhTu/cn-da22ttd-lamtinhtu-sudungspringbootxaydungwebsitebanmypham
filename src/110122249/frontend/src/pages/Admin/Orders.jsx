...
import { getAllOrders, updateOrderStatus, deleteOrder, updatePaymentStatus } from '../../api/order';
...
const Orders = () => {
    ...
    const handleDeleteOrder = (orderId) => {
        setConfirmMessage('Bạn có chắc chắn muốn xóa vĩnh viễn đơn hàng này? Hành động này không thể hoàn tác.');
        setConfirmAction(() => async () => {
            try {
                ...
                const errorMessage = err.response?.data?.message || 'Có lỗi xảy ra khi xóa đơn hàng';
                toast.error(errorMessage);
            }
        });
        setShowConfirm(true);
    ...
    // Removed handleCancelOrder as it is no longer used
